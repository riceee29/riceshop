  ...
  if (!user) return (
    <div className="gate">
      ...
      <style jsx>{`
        ...
        .gate-logo { width: 140px; height: 140px; border-radius: 30px; margin-bottom: 25px; }
        ...
        .anim-slide-in { animation: slideIn 1s cubic-bezier(0.2, 1, 0.3, 1); }
      `}</style>
    </div>
  );
  ...
  return (
    <div className="app-container">
      ...
      <main className="content">
        {view === 'shop' ? (
          <div className="shop-grid anim-fade-in">
            <div className="grid">
              {assets.map(asset => (
          ...
          <div className="form-view anim-fade-in">
            <div className="glass-form" style={{maxWidth:'750px'}}>
              <h2>ADMIN PANEL</h2>
              ...
              {adminInput === ADMIN_PASS && (
                <div className="admin-content">
                   <form onSubmit={handleUploadAsset} className="upload-form">
                    ...
                    <label style={{fontSize:'12px', display:'block', marginBottom:'10px'}}>로블록스 파일(.rbxm):</label>
                  ...
                  {adminCharges.length === 0 && <p style={{color:'#333', textAlign:'center'}}>대기 중인 요청이 없습니다.</p>}
                </div>
              )}
      ...
      <style jsx global>{`
        ...
        .status-item { background: #000; padding: 5px 12px; border-radius: 20px; border: 1px solid #111; color: #888; }
        .pending { color: #f1c40f; font-weight: 900; }
        ...
        .glass-form { background: #050505; border: 1px solid #111; padding: 60px; border-radius: 50px; width: 100%; max-width: 750px; box-shadow: 0 50px 100px rgba(0,0,0,1); }
        ...
        .admin-charge-item { display: flex; justify-content: space-between; align-items: center; background: #000; padding: 25px; border-radius: 25px; border: 1px solid #111; margin-bottom: 15px; }
        .admin-charge-item button { background: #00ff88; color: #000; border: none; padding: 12px 25px; border-radius: 15px; font-weight: 900; cursor: pointer; }
        .info strong { color: #8ec5fc; font-size: 1.1rem; }
        .info p { margin: 5px 0; color: #333; font-size: 12px; }
        .info code { background: #080808; padding: 5px 10px; border-radius: 5px; color: #fff; }
      `}</style>
    </div>
  );
}
